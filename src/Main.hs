...
import Language.Marlowe.ACTUS.LinearAmortizer as LinearAmortizer
...
main =
  ...
  let config@ContractConfig{..} =
      ...
      initState = LinearAmortizer.stateInit config
      generatedSchedules = generateSchedules LinearAmortizer.events config
